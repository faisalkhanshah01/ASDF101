		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php echo form_open_multipart($base_url.'language_controller/update_lang', 'class="form-horizontal"', 'id="update_clients"', 'method="post"'); ?>
					
					<?php foreach ($edit as $postt){ ?>
						<input type="hidden" value="<?php echo $postt->id; ?>" name="id" />
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6">
								...
								<span style="font-size:11px; color: #c42121;" >Note: Do not edit level once assign in view.</span>
							  </div>
							</div>
							...
							<div class="form-group">
								<div class="col-md-offset-4 col-md-8">
									<input type="submit" name="update_lang" class="btn btn-primary" id="update_clients" value="Update" />
