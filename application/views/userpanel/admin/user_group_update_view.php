			...
			<div class="col-md-offset-3 col-md-6">
				...
				<?php echo form_open(current_url(), 'class="form-horizontal"');	?>  	
						<legend>Group Details</legend>
								...
								<div class="col-md-8">
								<input type="text" id="group" class="form-control" name="update_group_name" value="<?php echo set_value('update_group_name', $group['cgrp_name']);?>"
                                                                ...
                                                                <select name="update_group_parent" class="form-control groups-tree">    
                                                                 <option value="<?php echo $client_group_id; ?>"> --Select parent --</option>
                                                                    <?php
                                                                        $client_id=$_SESSION['client']['client_id'];
                                                                        $client_group_id=$_SESSION['client']['group_id'];
                                                                        $selected_id=$group['cgrp_pid'];
                                                                       echo  $this->flexi_auth->groupTree($client_group_id,$group['cgrp_id'],$selected_id);
                                                                    ?>
                                                                </select>
							...
							<div class="form-group">
								...
								<textarea id="description" name="update_group_description" class="form-control"
									title="A short description of the purpose of the user group."><?php echo set_value('update_group_description', $group['cgrp_desc']);?></textarea>
								</div>	
							</div>
