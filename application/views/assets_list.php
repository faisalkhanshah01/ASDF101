...
<script>
	...
	<ul class="nav nav-tabs" role="tablist" style="margin-bottom:23px;">
	  ...
	  <li role="presentation"><a href="<?php echo $base_url;?>manage_kare/assets_search" class="hover_class"><?php if( $lang["view_asset_list"]['description'] !='' ){ echo $lang["view_asset_list"]['description']; }else{ echo "VIEW  ASSET LIST"; } ?></a></li>
          <li role="presentation" style="float:right"><a href="<?php echo $base_url;?>Manage_kare/download_asset_sample" class="hover_class"><?php if( $lang["download_sample_asset_excel"]['description'] !='' ){ echo $lang["download_sample_asset_excel"]['description']; }else{ echo "DOWNLOAD SAMPLE ASSET EXCEL"; } ?></a></li>
	</ul>
