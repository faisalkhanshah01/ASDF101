...
<meta name="designer" content="shaktisingh,ravindratiwari - Flash On Mind : shakti.singh@flashonmind .com"/>
				...
				<div class="col-md-12">
					...
					?>
							<div style="float:right;padding-top:40px;">
									<a href="<?php echo $base_url;?>" class="btn btn-primary act-but-prm" role="button">Switch login Kare</a> 
							</div>
					<?php }?>
                    <div class="col-md-6">
						<img src="<?php echo $includes_dir ?>images/new_logo_karaminfonet.png" title="kare logo" style="padding-bottom: 10px; padding-top: 10px;" width="250"/>
					</div>
