...
<meta name="author" content="">
	<link rel="icon" href="<?php echo $includes_dir ?>images/karam_logo.png" type="image/gif" sizes="16x16">
	...
	<link rel="stylesheet" href="<?php echo $includes_dir;?>css/custom.css">
        <link rel="stylesheet" href="<?php echo $includes_dir;?>css/skin/ui.fancytree.css">
        <link rel="stylesheet" href="<?php echo $includes_dir;?>css/css_createTreeView.css">
        <link rel="stylesheet" href="<?php echo $includes_dir;?>css/simple-sidebar.css">
        <link rel="stylesheet" href="<?php echo base_url().'includes/'; ?>css/style23.css">
	...
	<div class="container"> <!--  Container starting here and ending in footer.php  -->
		<div class="row">
			<div class="col-md-12">
                                ...
                                ?>
                                        <div class="col-md-4">
											<a href="http://karam.in/kare/infonet_details/about_us">
                                                <img class="header_image" src="<?php echo $includes_dir ?>images/KARAM-Infonet-logo.png" title="Karam infonet logo" style="padding-bottom: 20px; padding-top: 20px;" width="250"/>
											</a>
									   </div>
									   <div class="col-md-6">
                                ...
                                <?php }else{ ?>
                                        <div class="col-md-4">
                                                <img class="header_image" src="<?php echo $includes_dir ?>images/karam-kare-logo.png" title="Karam kare logo" />
                                        </div>
                                <?php }?>
							...
							?>
								<a class="navbar-brand pull-right hidden-xs" href="<?php echo $base_url;?>auth_public/update_account"> <img title="<?php echo $fullName; ?>" class="userImageInfonet" src="<?php echo $base_url;?>uploads/images/users/<?php echo $this->session->userdata('userImage'); ?>" width="100" height='100' alt="<?php echo $fullName; ?>" ></a>
