				...
				<div class="col-md-12">
					...
					?>
							<div style="float:right;padding-top:40px;">
									<a href="<?php echo $this->config->item('knowledgetree_url');?>/Infonet" class="btn btn-primary act-but-prm" role="button" style="background-color: <?php echo $_SESSION['color_code'];?>">knowledgetree Login</a> 
							</div>
					<?php }?>	
					<?php 
							...
							<div class="col-md-4">
								<a href="#">
									<?php if(!empty($_SESSION['logo']))  { ?>
										<img class="header_image" src="<?php echo $includes_dir.$_SESSION['logo']; ?>" title="Arresto logo" style="padding-bottom: 20px; padding-top: 20px;" width="250"/>
									<?php } else { ?>
					...
					<?php }else{ ?>
						<?php if(!empty($_SESSION['logo']))  { ?>
						<img class="header_image" src="<?php echo base_url($_SESSION['client']['logo']); ?>" title="Arresto logo" style="padding-bottom: 20px; padding-top: 20px;" width="250"/>
                                                <?php } else { ?>
                                                        <img class="header_image" src="<?php echo $includes_dir ?>images/system/arresto-logo.jpg" title="Arresto logo" style="padding-bottom: 20px; padding-top: 20px;" width="250"/>
                                                <?php } ?>
					<?php }?>
