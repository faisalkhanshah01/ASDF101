								...
								<div class="form-group">
									...
									<div class="col-md-8">
										...
										<?php 
											...
											$_SESSION['user_account']['previous_user_group'] = $user[$this->flexi_auth->db_column('user_acc', 'group_id')];
											$_SESSION['user_account']['user_groups'] = $groups;
                                                                                 */ 
