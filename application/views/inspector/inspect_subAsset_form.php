<?php $this->load->view('includes/header'); ?>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<legend class="home-heading">Inspect Sub Asset</legend>
			<div class="panel-default">
					<div class="panel-heading"><label>Site ID :</label> <?php echo $_SESSION['inspector']['siteid']; ?><p class="pull-right"><label>Date :</label> <?php echo $_SESSION['inspector']['form_submitting_date']; ?></p>
					</div>
				...
				<!--<div class="col-md-12 inspectionFirst" >-->
					<form class="form-horizontal" id="inspect_asset_form" action="" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								<label for="asset_name" class="col-md-3 control-label">Sub Asset Name:</label>
								<div class="col-md-8">
									<input type="text" class="form-control inspection_form" id="asset_name" name="asset_name" value="<?php echo $_SESSION['inspector']['subAsset_code']; ?>" readonly />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<ol>
										<?php foreach($_SESSION['inspector']['subAsset_result'] as $key=>$result) { ?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="form-control"><?php echo $_SESSION['inspector']['subAsset_inspection'] ?></div>
								</div>
							</div>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="form-control observation_type" id="observation_type" rel='0' name="obs[0][observation_type]" required>
														...
														<?php foreach($_SESSION['inspector']['subAsset_observation'] as $key=>$obser) { ?>
							...
							<div class="form-group">
								<div class="col-md-offset-6 col-md-6">
									<button type="submit" class="btn btn-info" name="get_inspect_subAsset" id="get_inspect_subAsset" value="get_inspect_subAsset">Get Inspect SubAsset</button>
								</div>
							</div>
					</form>
				</div>
