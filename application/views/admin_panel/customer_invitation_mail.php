...
<div class="col-md-8 col-md-offset-2 after-login-forms" id="customer-registration-mail">
	...
	<div class="col-md-8 col-md-offset-2 form">
		...
		echo form_open_multipart("admin/auth_admin/new_customer_invitation", $attributes);?>
		...
		<div class="form-group">
			<button name="invite_submit" type="submit" value="submit" class="btn btn-default btn-block">Send Mail</button>
		</div>
