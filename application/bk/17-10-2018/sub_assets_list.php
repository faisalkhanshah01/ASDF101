	...
	<div class="row">
		<div class="col-md-12">
			<ul class="nav nav-tabs" role="tablist" style="margin-bottom:23px;">
				...
				<li role="presentation"><a href="<?php echo $base_url;?>manage_kare/download_subAsset_sample"><?php if( $lang["download_sample_sub_asset_data"]['description'] !='' ){ echo $lang["download_sample_sub_asset_data"]['description']; }else{ echo "DOWNLOAD SAMPLE SUB ASSET DATA"; } ?></a></li>
