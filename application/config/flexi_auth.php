...
*/
	...
	*/   
	...
	/*$config['database']['user_acc']['custom_columns'] = array(
        ...
        $config['database']['user_acc']['custom_columns'] = array(
		'uacc_client_fk','uacc_logo','uacc_color_code','uacc_cgroup_fk','uacc_device_type','uacc_device_token'
	);
	...
	*/ 
	...
	$config['database']['user_group']['columns']['admin'] = 'ugrp_admin';
        $config['database']['user_group']['columns']['pid'] = 'ugrp_pid';
	...
	*/ 
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'upro_first_name','upro_last_name','upro_phone','upro_image','upro_newsletter','emp_id','emp_region','upro_landline','upro_company','upro_country_id','upro_zone_id','upro_city_id'
	);
	...
	*/ 
	...
	/**
	 * Custom Project Master Data Table
	 * Example table used to hold address data on each user.
	 * By holding this data in a separate table from the profile data table above, a user can save multiple addresses.
	 *
	 * reated by Shakti Singh on 27-Nov-2015
	*/ 
	//$config['database']['custom']['master_data']['table'] = 'master_data_form';
	//$config['database']['custom']['master_data']['primary_key'] = 'mdata_id';
	//$config['database']['custom']['user_address']['foreign_key'] = 'uadd_uacc_fk';
	//$config['database']['custom']['user_address']['join'] = 'demo_user_address.uadd_uacc_fk';
	//$config['database']['custom']['master_data']['custom_columns'] = array('mdata_client_name','mdata_project_address','mdata_city','mdata_state','mdata_bp_code','mdata_cost_centre','mdata_po_info','mdata_area','mdata_project_nature','mdata_project_manager_name','mdata_project_head_name','mdata_inserted_date','mdata_updation_date','mdata_user_id'
	//);
	...
	*/
	...
	/*
	Changes Made by Shakti Singh to send Email via SMTP.
	*/
	###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###
	
	// Site title shown as 'from' header on emails.
	$config['email']['site_title'] = "KARE by Arresto";    // Changed by Shakti Singh 
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "kare@arresto.in";      // Changed by Shakti Singh 
	...
	*/
	...
	/**
		* Code Change by Shakti Singh on 24-11-2015
		* This code is added to send Email via SMTP
	*/
	...
	*/
	...
	#$config['email']['smtp_host'] = "ssl://email-smtp.us-east-1.amazonaws.com";
	$config['email']['smtp_host'] = "smtp.elasticemail.com'";
                             
	/**
	* SMTP Username.
	*/
	 
	#$config['email']['smtp_user'] = "AKIAI2FY2JSZE4RO7EMQ";
	$config['email']['smtp_user'] = "b7de0525-1808-4214-83b6-dcfaabbbe996";
	 
	/**
	* SMTP Password.
	*/
	 
	#$config['email']['smtp_pass'] = "ArYO5eKgrvsl0CtPFUcohqU8qp8peQ4xSKlBnlJru4JY";
	$config['email']['smtp_pass'] = "b7de0525-1808-4214-83b6-dcfaabbbe996";
	...
	*/
	...
	$config['email']['bcc_emails'] = array("varun@flashonmind.com","shakti.singh@flashonmind.com");
	//$config['email']['bcc_emails'] = array("shakti.singh@flashonmind.com");
	
	/**
	* SMTP Encryption. Can be "", "ssl","tls". Default is ""
	*/
	...
	*/
	...
	/**
	 * 'Inspection' email template.
	 * Default: 'inspection_email.tpl.php'
	*/
	$config['email']['email_template_inspection'] = 'inspection_email.tpl.php';
	...
	*/
	...
	##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	// INFONET EMAIL TAMPLETS
	/**
	 * 'Activate Account' email template.
	 * Default: 'activate_account.tpl.php'
	*/
	$config['email']['infonet_email_template_activate'] = 'infonet_activate_account.tpl.php';
	$config['email']['infonet_email_template_activate_resend_account'] = 'infonet_resend_activate_account.tpl.php';
	$config['email']['infonet_email_template_activate_new_user'] = 'infonet_activate_account_new_user.tpl.php';
	
	/**
	 * 'Forgot Password' email template.
	 * Default: 'forgot_password.tpl.php'
	*/
	$config['email']['infonet_email_template_forgot_password'] = 'infonet_forgot_password.tpl.php';

	/**
	 * 'Forgot Password Complete' email template.
	 * Default: 'new_password.tpl.php'
	*/
	$config['email']['infonet_email_template_forgot_password_complete'] = 'infonet_new_password.tpl.php';

	/**
	 * 'Update Email' email template.
	 * Default: 'update_email_address.tpl.php'
	*/
	$config['email']['infonet_email_template_update_email'] = 'infonet_update_email_address.tpl.php';
	...
	*/
	...
	$config['messages']['delimiters']['status_prefix'] = '<p class="alert alert-success">';
	
	// Message End Delimiter
	$config['messages']['delimiters']['status_suffix'] = '</p>';
	
	// Error Start Delimiter
	$config['messages']['delimiters']['error_prefix'] = '<p class="alert alert-danger capital">';
