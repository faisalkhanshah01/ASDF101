...
class Auth extends CI_Controller {
    ...
    function __construct() {
        ...
        // parsing the login-user type 
        if ($this->flexi_auth->is_logged_in_via_password() && uri_string() != 'admin/auth/logout') {
    ...
    function index() {
        ...
        //$this->load->view('admin_panel/admin_login_view', $data);
        
        $this->load->view('adminpanel/login_view', $this->data);
    ...
    function register_account() {
        ...
        // If 'Registration' form has been submitted, attempt to register their details as a new account.
            ...
            $this->load->model('arresto_auth_model');
            $this->arresto_auth_model->register_account();
        }
        ...
        $this->load->view('admin_panel/register_view', $this->data);
    }
    ...
    public function forgotten_password() {
        ...
        if ($this->input->post('send_forgotten_password')) {
            $this->load->model('arresto_auth_model');
            $this->arresto_auth_model->forgotten_password();
        }

        // Get any status message that may have been set.
        $this->data['message'] = (!isset($this->data['message'])) ? $this->session->flashdata('message') : $this->data['message'];

        $this->load->view('adminpanel/public/forgot_password_view', $this->data);
        
        //$this->load->view('admin_panel/forgot_password_view', $this->data);
    }
    ...
    function manual_reset_forgotten_password($user_id = FALSE, $token = FALSE) {
        ...
        $this->load->view('adminpanel/public/forgot_password_update_view', $this->data);
    }
